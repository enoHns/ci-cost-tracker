import { CloudProvider, RunnerPricing } from './types'

// GitHub Actions pricing (USD/minute, as of 2025)
// https://docs.github.com/en/billing/managing-billing-for-github-actions/about-billing-for-github-actions
const GITHUB_PRICING: Record<string, RunnerPricing> = {
...
const AWS_PRICING: Record<string, RunnerPricing> = {
...
const GCP_PRICING: Record<string, RunnerPricing> = {
...
const AZURE_PRICING: Record<string, RunnerPricing> = {
...
export function getPricing(provider: CloudProvider, runnerLabel: string): RunnerPricing {
